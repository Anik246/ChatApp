...
public class ReaderWriterServerThread implements Runnable {

    String username;
    NetworkUtil nc;
    HashMap<String, Information> clientList;

    public ReaderWriterServerThread(String user, NetworkUtil netConnection, HashMap<String, Information> cList) {
        username = user;
        nc = netConnection;
        clientList = cList;
    }
